...
export default function UserPermissions() {
  ...
  const [users] = useState([
    { id: 1, name: 'Somchai Jaidee', position: 'Plant Manager', email: 'somchai@animalhealth.com', avatar: 'https://i.pravatar.cc/150?img=11', isDev: false },
    { id: 2, name: 'Suda Rakdee', position: 'QA Lead', email: 'suda@animalhealth.com', avatar: 'https://i.pravatar.cc/150?img=5', isDev: false },
    { id: 3, name: 'Developer Team', position: 'System Admin', email: 'admin@animalhealth.com', avatar: 'https://i.pravatar.cc/150?img=12', isDev: true },
  ]);
        ...
        <div className="fixed inset-0 z-[600] flex justify-end animate-in fade-in duration-300">
            ...
            <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-10 text-[#4F868C] leading-relaxed text-thai">
                    <section><h4 className="font-black text-[#141A26] border-b border-[#141A26]/10 pb-2 mb-4 flex items-center gap-2"><span className="bg-[#F2B705] text-[#141A26] font-mono w-6 h-6 rounded-full flex items-center justify-center text-[12px]">01</span> การซิงค์เมนูอัตโนมัติ</h4><p className="text-[13px]">Master Module Registry ถูกออกแบบให้ดึงค่าจาก Source of Truth เดียวกับ Sidebar ของ ANIMAL HEALTH เพื่อให้มั่นใจว่าทุกฟังก์ชันใหม่จะถูกกำหนดสิทธิ์ก่อนใช้งานเสมอ</p></section>
                    <section><h4 className="font-black text-[#141A26] border-b border-[#141A26]/10 pb-2 mb-4 flex items-center gap-2"><span className="bg-[#D95032] text-white font-mono w-6 h-6 rounded-full flex items-center justify-center text-[12px]">02</span> ลำดับสิทธิ์ (Hierarchy)</h4><p className="text-[13px]">สิทธิ์ระดับ Verifier (3) และ Approver (4) จะมีอำนาจการจัดการในขั้นตอนสุดท้ายของ Workflow เอกสารการผลิต และ สูตรต่างๆ เสมอ</p></section>
                </div>
