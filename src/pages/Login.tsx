  ...
  return (
    <div className="relative flex min-h-screen w-full font-mono bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://www.allaboutfeed.net/app/uploads/2020/12/001_916_rb-image-2657681.jpeg')`
        }}
      />
        ...
        <div className="hidden w-1/2 flex-col justify-between bg-[#111f42]/40 p-12 lg:flex backdrop-blur-sm border-r border-white/10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 text-white mb-16">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f47729] shadow-lg shadow-[#f47729]/20">
                <Package size={20} className="text-white" strokeWidth={2.5} />
              </div>
              <span className="text-[15px] font-bold tracking-[0.15em] hover:text-[#f47729] transition-colors cursor-pointer">
            ...
            >
              ...
              <h2 className="text-[26px] font-bold text-white mb-8 tracking-wide drop-shadow-md">
                Feed Additive and Veterinary Management System
              </h2>
              <p className="max-w-md text-[15px] leading-relaxed text-white/80 font-medium">
                Streamline your inventory, optimize<br />
                logistics, and take full control of your<br />
                supply chain with our advanced management<br />
                platform.
              </p>
          ...
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="Card ID or Password"
                      value={idCard}
              ...
              <div className="mt-8 rounded-xl bg-white/60 p-5 text-center shadow-inner border border-white/60 backdrop-blur-sm">
                <div className="font-bold text-[#1a2035] text-[13px] mb-1.5">Operator (Demo)</div>
                <div className="text-[13px] font-semibold text-slate-700">Staff Code: DEMO<br />Card ID: DEMO123456789</div>
              </div>
            </form>
          </motion.div>
        </div>
